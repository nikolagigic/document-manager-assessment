...
# Get the secret key with a default value for development
SECRET_KEY = env("DJANGO_SECRET_KEY", default="django-insecure-tNWIWtWg00GhItEIOxu8CtyBKPSOLhg5RL1XKyAjLitSBpB2Na32WSV87papatye")
